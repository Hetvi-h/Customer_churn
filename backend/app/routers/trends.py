...
def get_churn_trends(
    ...
    try:
        ...
        print(f"Error in get_churn_trends: {e}")
        return ChurnTrendResponse(
            trend_data=[],
            period=period,
            summary={"period": period, "message": "Error loading trends"}
        )
...
def generate_synthetic_trends(db: Session, days: int) -> List[TrendDataPoint]:
    ...
    try:
        ...
        print(f"Error in generate_synthetic_trends: {e}")
        return []
...
def get_prediction_trends(
    ...
    try:
        ...
        print(f"Error in get_prediction_trends: {e}")
        return {"period": period, "data": [], "total_predictions": 0}
...
def get_risk_evolution(
    ...
    try:
        ...
        print(f"Error in get_risk_evolution: {e}")
